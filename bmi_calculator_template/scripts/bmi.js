function calculateBmi() {
    ...
    if (isNaN(weight) || isNaN(height) || weight <= 0 || height <= 0) {
        document.getElementById("output").innerHTML = Please enter valid height and weight values.;
    ...
    if (bmi < 18.5) {
        document.getElementById("output2").innerHTML = `
            ...
            <div class="mt-3">
                <i class="fa-solid fa-scale-unbalanced fa-4x" style="color: rgba(0, 162, 255, 1);"></i>
            </div>`;
    } 
        ...
        document.getElementById("output2").innerHTML = `
            ...
            <div class="mt-3">
                <i class="fa-solid fa-scale-balanced fa-4x" style="color: rgba(38, 255, 0, 1);"></i>
            </div>`;
    } 
        ...
        document.getElementById("output2").innerHTML = `
            ...
            <div class="mt-3">
                <i class="fa-solid fa-scale-unbalanced fa-4x" style="color: rgba(255, 234, 0, 1);"></i>
            </div>`;
    } 
    else {
        document.getElementById("output2").innerHTML = `
